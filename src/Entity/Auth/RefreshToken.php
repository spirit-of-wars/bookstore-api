 ...
 * @ORM\Table(name="auth.refresh_token")
...
class RefreshToken extends BaseEntity
{
    ...
    /** @ORM\OneToOne(targetEntity="App\Entity\Auth\ConfirmLink", mappedBy="refreshToken") */
    private $confirmLink;

    /** @ORM\OneToOne(targetEntity="App\Entity\User", inversedBy="refreshToken") */
    private $user;
}
